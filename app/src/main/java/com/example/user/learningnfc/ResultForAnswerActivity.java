...
public class ResultForAnswerActivity extends Activity {
...
//    test
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_result_for_answer);
    ...
    class GetProductDetails extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(ResultForAnswerActivity.this);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event)
    {
        if(keyCode == KeyEvent.KEYCODE_BACK){
            ...
            myIntent = new Intent(ResultForAnswerActivity.this, ResultActivity.class);
